  ...
  if (!account) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 flex items-center justify-center p-4">
        <Card className="w-full max-w-md bg-gray-800/50 border-purple-500/30 backdrop-blur-sm">
          <CardHeader className="text-center">
            <Link href="/" className="flex items-center text-purple-400 mb-4 hover:text-purple-300">
            ...
            <p className="text-gray-400">Connect your wallet to challenge other players</p>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 p-4">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <Card className="bg-gray-800/50 border-purple-500/30 backdrop-blur-sm">
          <CardHeader>
            <div className="flex justify-between items-center">
              ...
              <Badge className="bg-purple-600 text-white">Round {Math.floor((gameState - 1) / 6) + 1}/4</Badge>
            </div>
          </CardHeader>
        </Card>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <CardHeader>
              <CardTitle className="text-white flex items-center justify-between">
                <span>Player 1 {myPlayerIndex === 0 && "(You)"}</span>
          ...
          <Card
            className={`bg-gray-800/50 border-2 backdrop-blur-sm transition-all duration-300 ${
              myPlayerIndex === 1 ? "border-red-500 shadow-red-500/20 shadow-lg" : "border-gray-600"
            }`}
          >
            <CardHeader>
              <CardTitle className="text-white flex items-center justify-between">
                <span>Player 2 {myPlayerIndex === 1 && "(You)"}</span>
                <div className="flex items-center space-x-2">
                  <Coins className="w-4 h-4 text-yellow-400" />
